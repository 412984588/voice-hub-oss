...
describe('@voice-hub/claude-marketplace', () => {
  describe('MANIFEST', () => {
    ...
    it('should have repository URLs', () => {
      ...
      expect(MANIFEST.repository).toBe('https://github.com/voice-hub/voice-hub');
    });
    ...
    it('should have dependencies defined', () => {
      ...
      expect(MANIFEST.dependencies.runtime).toContain('@voice-hub/core-runtime');
      expect(MANIFEST.dependencies.optional).toContain('@voice-hub/openclaw-plugin');
    });

    it('should have installation config', () => {
      expect(MANIFEST.installation).toBeDefined();
      expect(MANIFEST.installation.type).toBe('npm');
      expect(MANIFEST.installation.package).toBe('@voice-hub/claude-marketplace');
    });
  ...
  describe('CLAUDE_CODE_PLUGIN', () => {
    ...
    it('should have voice commands defined', () => {
      ...
      const startCommand = CLAUDE_CODE_PLUGIN.commands.find((c: any) => c.name === 'voice.start');
    ...
    it('should have settings defined', () => {
      ...
      const providerSetting = CLAUDE_CODE_PLUGIN.settings.find((s: any) => s.key === 'voice.provider');
    ...
    it('should have notifications defined', () => {
      ...
      const sessionStarted = CLAUDE_CODE_PLUGIN.notifications.find((n: any) => n.event === 'session.started');
